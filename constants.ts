...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  { id: 'm13', category: 'Musik & Instrumente', german: 'Am Samstag musiziere ich in der Band./Am Samstag mache ich in der Band Musik.', english: 'On Saturday I make music in the band.' },
  // 2. Sport & Action
  { id: 's1', category: 'Sport & Action', german: 'Am Montag schwimme ich im See.', english: 'On Monday I swim in the lake.' },
  { id: 's2', category: 'Sport & Action', german: 'Am Dienstag rudere ich gern.', english: 'On Tuesday I enjoy rowing.' },
  ...
  { id: 's16', category: 'Sport & Action', german: 'Am Dienstag wandere ich mit meiner Familie.', english: 'On Tuesday I hike with my family.' },
  { id: 's17', category: 'Sport & Action', german: 'Am Mittwoch klettere ich in der Halle.', english: 'On Wednesday I climb in the hall.' },
  { id: 's18', category: 'Sport & Action', german: 'Am Wochenende bouldere ich in der Halle.', english: 'At the weekend I boulder in the hall.' },
  { id: 's19', category: 'Sport & Action', german: 'Am Donnerstag fahre ich Ski.', english: 'On Thursday I go skiing.' },
  { id: 's20', category: 'Sport & Action', german: 'Am Freitag fahre ich Rad.', english: 'On Friday I cycle.' },
  { id: 's21', category: 'Sport & Action', german: 'Am Samstag fahre ich Skateboard.', english: 'On Saturday I ride a skateboard.' },
  { id: 's22', category: 'Sport & Action', german: 'Am Wochenende fahre ich Rollschuh.', english: 'At the weekend I go rollerskating.' },
  { id: 's23', category: 'Sport & Action', german: 'Am Wochenende fahre ich Schlittschuh.', english: 'At the weekend I go ice skating.' },
  { id: 's24', category: 'Sport & Action', german: 'Am Sonntag gehe ich eislaufen.', english: 'On Sunday I go ice skating.' },
  { id: 's25', category: 'Sport & Action', german: 'Am Montag mache ich Yoga.', english: 'On Monday I do yoga.' },
  { id: 's26', category: 'Sport & Action', german: 'Am Dienstag mache ich Karate.', english: 'On Tuesday I do karate.' },
  { id: 's27', category: 'Sport & Action', german: 'Am Mittwoch mache ich Ballett.', english: 'On Wednesday I do ballet.' },
  { id: 's28', category: 'Sport & Action', german: 'Am Donnerstag spiele ich Dart.', english: 'On Thursday I play darts.' },
  { id: 's29', category: 'Sport & Action', german: 'Am Freitag gehe ich bowling.', english: 'On Friday I go bowling.' },
  // 3. Zu Hause & Kreativ
  { id: 'h1', category: 'Zu Hause & Kreativ', german: 'Am Samstag spiele ich Theater.', english: 'On Saturday I act / play theatre.' },
  { id: 'h2', category: 'Zu Hause & Kreativ', german: 'Am Sonntag fotografiere ich meinen Hund.', english: 'On Sunday I take photos my dog.' },
  { id: 'h4', category: 'Zu Hause & Kreativ', german: 'Am Dienstag bastle ich gern.', english: 'On Tuesday I enjoy crafting.' },
  ...
  { id: 'h9', category: 'Zu Hause & Kreativ', german: 'Am Sonntag sehe ich fern.', english: 'On Sunday I watch TV.' },
